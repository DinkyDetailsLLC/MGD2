...
NSString *kPaused        = @"PausedKey";
NSString *kRemainingTime = @"RemainingTimeKey";
...
- (void)pause
{
	...
	NSNumber *isPausedNumber = [[self pauseDictionary] objectForKey:kPaused];
	...
	[[self pauseDictionary] setObject:[NSNumber numberWithDouble:remainingTimeInterval] forKey:kRemainingTime];
    
	// Pause timer
	[self setFireDate:[NSDate distantFuture]];
	[[self pauseDictionary] setObject:[NSNumber numberWithBool:YES] forKey:kPaused];
}
...
- (void)resume
{
	...
	NSTimeInterval remainingTimeInterval = [[[self pauseDictionary] objectForKey:kRemainingTime] doubleValue];
	...
	[[self pauseDictionary] setObject:[NSNumber numberWithBool:NO] forKey:kPaused];
}
